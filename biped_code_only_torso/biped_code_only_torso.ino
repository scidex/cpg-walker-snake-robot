...
int mySpeed = 110; // 100; /* from 0 to 255. 255 is full motor speed*/
int hipstep = 80; /*50 */ 
int torsoStep = 130; /*120 */
int myd = 4; //ms /*5 a delay between to commands to motors, it should be as small as possible */
int myd2 = 1000;//ms  // 1000
int myd3 = 20; /*20 a delay between to sensors readings sycles */
int hight_factor = 2.7; /* 2 a multiplication factor for the hight of the feet in swing phase*/
